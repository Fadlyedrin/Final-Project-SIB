...
<div class="container-fluid z-0">
    <div class="row">
        ...
        <div>
            <a href="{{ route('tambahDataPengguna') }}"><button class="btn ms-4 text-light fw-medium py-2" style="font-size: 20px; background-color:var(--tertiary-color)">Tambah Data +</button></a>
        </div>
        </div>
        ...
        <tbody>
            <tr>
                <td>1</td>
                <td>Kartho</td>
                <td>kartho@gmmail.com</td>
                <td>08123456</td>
                <td>Admin</td>
                <td>
                    <a href="{{ route('editDataPengguna') }}"><button class="btn btn-sm btn-primary me-2"><i class="bi bi-pencil"></i></button></a>
