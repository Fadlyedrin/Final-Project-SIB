...
<div class="container-fluid">
    ...
    <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block sidebar">
      <a class="navbar-brand d-flex justify-content-center " href="{{route('admin')}}"
      ...
      <div class="position-sticky">
        <ul class="nav flex-column mt-5">
          ...
          <li class="nav-item mb-3">
            <a class="nav-link {{ request()->is('*/editdataadmin', '*/editdataadmin/*') ? 'active' : '' }}" aria-current="page" href="{{ route('editDataAdmin', ['user' => Auth::user()->id]) }}">
