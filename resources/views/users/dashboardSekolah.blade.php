...
@section('content')
    <div class="container" style="margin-top: 80px; height: 100%">
        <div class="row">
            <div class="col-md-12">
                <img src="{{ asset($sekolah->gambarSekolah->first()->gambar) }}" height="550" width="1287" alt="" style="object-fit: cover" />
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-6 mt-5">
                <img src="{{ asset($sekolah->gambarSekolah->first()->gambar) }}" class=" object-fit-cover" width="635" height="570" alt="" />
            </div>
            <div class="col-6 mt-5">
        ...
        <div class="row">
            ...
            <div class="col-6 mt-5">
                <img src="{{ asset($sekolah->logo) }}" width="635" height="570" alt="" />
            </div>
            <div class="col-6 mt-5">
                <h2>Visi</h2>
